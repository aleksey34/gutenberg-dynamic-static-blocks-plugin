...
class AlexEventsAllEventsDynamic{

    public function __construct(){
       
        add_action( 'init', [$this , 'events_all_events'] );

    }

    public function  events_all_events(){

 
        register_block_type( ALEX_PLUGIN_GUTEN_DIR . '/build/dynamic-events-block',
        [
